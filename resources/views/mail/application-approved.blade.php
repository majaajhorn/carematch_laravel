...
<body class="bg-gray-100">
    <div class="max-w-2xl mx-auto p-4">
        ...
        <div class="bg-emerald-600 text-white p-6 text-center rounded-t-lg">
            <h1 class="text-2xl font-bold">Application Approved</h1>
        </div>
        ...
        <div class="bg-gray-50 p-6 border-l border-r border-gray-200">
            ...
            <p class="text-gray-800 mb-6">
                <span class="font-bold">Congratulations!</span> Your application has been successfully approved by the
                employer!
            </p>
            ...
            <div class="mb-6">
                ...
                <ul class="space-y-2 text-gray-700">
                    ...
                    <li class="flex items-start">
                        <span class="text-emerald-600 mr-2">•</span>
                        They will contact you directly for next steps
                    </li>
                </ul>
            </div>
