...
<body class="bg-gray-100">
    <div class="max-w-2xl mx-auto p-4">
        ...
        <div class="bg-emerald-600 text-white p-6 text-center rounded-t-lg">
            <h1 class="text-2xl font-bold">Application Confirmation</h1>
        </div>
        ...
        <div class="bg-gray-50 p-6 border-l border-r border-gray-200">
            ...
            <p class="text-gray-800 mb-6">
                <span class="font-bold">Congratulations!</span> Your application has been successfully submitted to the
                employer.
            </p>
            ...
            <div class="mb-6">
                <p class="text-gray-800 font-medium mb-3">What happens next?</p>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-start">
                        <span class="text-emerald-600 mr-2">•</span>
                        The employer has been notified of your application
                    </li>
                    <li class="flex items-start">
                        <span class="text-emerald-600 mr-2">•</span>
                        They will review your cover letter and resume
                    </li>
                    <li class="flex items-start">
                        <span class="text-emerald-600 mr-2">•</span>
                        If selected, they will contact you directly for next steps
                    </li>
                </ul>
            </div>

            <p class="text-gray-700 mb-4">
                You can view your application status anytime by logging into your CareMatch account.
            </p>
